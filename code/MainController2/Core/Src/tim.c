...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    PA6     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = EJCMT_EN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM16;
    HAL_GPIO_Init(EJCMT_EN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim == (&htim16))
  {
    extern uint16_t motor_pwm_width;
    motor_pwm_width = (motor_pwm_width + MT_PWM_STEP) < PWM_FSPEED ? (motor_pwm_width + MT_PWM_STEP) : MAX_PWM_WIDTH;
