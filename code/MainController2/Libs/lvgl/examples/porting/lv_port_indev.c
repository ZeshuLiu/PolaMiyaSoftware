 ...
 *      DEFINES
 *********************/
const uint16_t KEY_Pins_lvgl[USR_KEY_COUNT] = {KEY0_Pin, KEY1_Pin, KEY2_Pin};
const GPIO_TypeDef * KEY_Ports_lvgl[USR_KEY_COUNT] = {KEY0_GPIO_Port, KEY1_GPIO_Port, KEY2_GPIO_Port};
/**********************
 *      TYPEDEFS
 **********************/
...
static int8_t button_get_pressed_id(void)
{
    ...
    /*Check to buttons see which is being pressed (assume there are 3 buttons)*/
    for(i = 0; i < 3; i++) {
...
static bool button_is_pressed(uint8_t id)
{
    ...
    /*Your code comes here*/
    GPIO_PinState st = HAL_GPIO_ReadPin((GPIO_TypeDef *) KEY_Ports_lvgl[id], KEY_Pins_lvgl[id]);
    return (bool) st;
}
