...
// /* 初始化第二界面样式 */
// static void init_screen2_styles(void)
// {
//     /* 第二界面背景样式 */
//     lv_obj_set_style_bg_color(screen2_cont, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
//     lv_obj_set_scrollbar_mode(screen2_cont, LV_SCROLLBAR_MODE_OFF);
// }
...
void setup_scr_MainFun(lv_ui *ui){
    ...
    lv_obj_set_pos(ui->MainFun_label_Dist, 66, 225);
    lv_obj_set_size(ui->MainFun_label_Dist, 76, 12);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_Dist, &lv_font_montserrat_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_bottom(ui->MainFun_label_Dist, 6, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_DistDash2, 105, 198);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_DistDash2, &lv_font_montserrat_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_DistDash3, 150, 203);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_DistDash3, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_DistDash1, 60, 203);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_DistDash1, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_DistDash4, 187, 214);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_DistDash4, &lv_font_montserrat_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_DistDash0, 23, 214);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_DistDash0, &lv_font_montserrat_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_line_2, 120, 217);
    ...
    lv_obj_set_pos(ui->MainFun_line_3, 120, 196);
    ...
    lv_obj_set_pos(ui->MainFun_ProjName, 33, 7);
    ...
    lv_obj_set_style_text_font(ui->MainFun_ProjName, &lv_font_montserrat_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_RunTime, 121, 8);
    ...
    lv_obj_set_style_text_font(ui->MainFun_RunTime, &lv_font_montserrat_16, LV_PART_MAIN|LV_STATE_DEFAULT);
...
//     lv_obj_set_pos(ui->MainFun_chart_1, 33, 121);
...
//     lv_obj_set_style_line_opa(ui->MainFun_chart_1, 73, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CahrtTitle, 79, 105);
    lv_obj_set_size(ui->MainFun_label_CahrtTitle, 97, 12);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CahrtTitle, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CharTime4, 207, 173);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CharTime4, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CharTime3, 163, 173);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CharTime3, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CharTime2, 121, 173);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CharTime2, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CharTime1, 72, 173);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CharTime1, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CharTime0, 29, 173);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CharTime0, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_CharTLower, 8, 155);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_CharTLower, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_ChartUpper, 8, 125);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_ChartUpper, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_ChartMiddle, 8, 140);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_ChartMiddle, &lv_font_montserrat_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_RBC, 23, 40);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_RBC, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_MTL, 23, 60);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_MTL, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_STC, 23, 80);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_STC, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_Val, 129, 40);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_Val, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_MTLVal, 101, 60);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_MTLVal, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_label_STCVal, 129, 80);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_STCVal, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainFun_line_5, 0, 99);
    ...
    lv_obj_set_pos(ui->MainFun_line_6, 4, 4);
    ...
    lv_obj_set_pos(ui->MainFun_line_7, 4, 9);
    ...
    lv_obj_set_pos(ui->MainFun_line_8, 4, 14);
    ...
    lv_obj_set_pos(ui->MainFun_line_9, 4, 20);
    ...
    lv_obj_set_pos(ui->MainFun_line_10, 4, 25);
    ...
    lv_obj_set_pos(ui->MainFun_label_DistVal, 129, 225);
    lv_obj_set_size(ui->MainFun_label_DistVal, 43, 12);
    ...
    lv_obj_set_style_text_font(ui->MainFun_label_DistVal, &lv_font_montserrat_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_bottom(ui->MainFun_label_DistVal, 6, LV_PART_MAIN|LV_STATE_DEFAULT);
...
void lvgl_update_display(void)
{
    ...
    if (current_screen == 1 || ui2.MainFun) {
        ...
        // /* 更新温度图表 */
        // if (MainFun_chart_1 && MainFun_chart_series_1) {
        ...
        //     /* 更新图表数据 */
        //     lv_chart_set_next_value(MainFun_chart_1, MainFun_chart_series_1, temp_val);
        // }
    }
}
